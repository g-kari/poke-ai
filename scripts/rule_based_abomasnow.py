"""Mega Abomasnow ex rule-based agent — saved for benchmark comparison only.
...
_DECK_BASENAME = "deck_abomasnow.csv"
file_path = os.environ.get("RULE_DECK_PATH_ABOMASNOW")
if not file_path:
