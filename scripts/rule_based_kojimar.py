"""Vendored from Kaggle kernel:
  kojimar/validated-rule-based-agent-matchup-tests
  https://www.kaggle.com/code/kojimar/validated-rule-based-agent-matchup-tests

32 votes. Lucario + Hariyama + Solrock with reported matchup validation.

Adapted: deck path uses RULE_DECK_PATH_KOJIMAR with fallback to repo-root
deck_kojimar.csv or /kaggle_simulations/agent/deck.csv.
"""
...
_DECK_BASENAME = "deck_kojimar.csv"
DECK_PATH = os.environ.get("RULE_DECK_PATH_KOJIMAR")
if not DECK_PATH:
    _here = os.path.dirname(os.path.abspath(__file__))
    DECK_PATH = os.path.join(os.path.dirname(_here), _DECK_BASENAME)
